...
p = [];
notAvailableArtists = ['Clever','Cardi B','Chlöe','Jason Derulo','Jhorrmountain','Puri','Eric Nam','Estelle','Kansh','Liili','UPSAHL','Arctic Monkeys','LEARNING','Harm Franklin','Lil Wuyn','Young Thug','Chris Brown','Sia','ZAYN','Đen','Trí Dũng','Fishy','Groovie','Lil Uzi Vert','Cam','Jenevieve','Clams Casino','kyuuwaii','MinhLai','LeeHi','Anh Phan','Negav','sped up nightcore', 'ARIZONATEARS','bbygirl','DWELLS','Wxrdie','PAR SG','Vũ Thanh Vân','Saabirose','SIVAN','Nguyên','Seth','New$oulZ','THDC','Han Kim','Lã Thắng','Dfoxie37', 'Myhai',
